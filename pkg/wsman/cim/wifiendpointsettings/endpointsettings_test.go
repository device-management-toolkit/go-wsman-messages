...
func TestJson(t *testing.T) {
	...
	expectedResult := "{\"XMLName\":{\"Space\":\"\",\"Local\":\"\"},\"EnumerateResponse\":{\"EnumerationContext\":\"\"},\"PullResponse\":{\"XMLName\":{\"Space\":\"\",\"Local\":\"\"},\"EndpointSettingsItems\":null},\"RequestStateChange_OUTPUT\":{\"XMLName\":{\"Space\":\"\",\"Local\":\"\"},\"ReturnValue\":0,\"ReturnValueStr\":\"\"}}"
...
func TestPositiveCIMWifiEndpointSettings(t *testing.T) {
	...
	client := wsmantesting.MockClient{
		PackageUnderTest: "cim/wifiendpointsettings",
	}
