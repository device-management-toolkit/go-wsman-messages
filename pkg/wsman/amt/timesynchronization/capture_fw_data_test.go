...
package timesynchronization_test
...
func TestCaptureFirmwareXMLTimeSynchronizationService(t *testing.T) {
	...
	service := timesynchronization.NewTimeSynchronizationServiceWithClient(wsmanMessageCreator, wsmanClient)
	...
	defaultOutputDir := filepath.Join(
		...
		"..", "..", "..", "wsmantesting", "responses", "amt", "timesynchronization",
	)
