...
func TestJson(t *testing.T) {
	...
	assert.Contains(t, result, "RemoteAccessCapabilitiesGetResponse")
	assert.Contains(t, result, "RemoteAccessServiceGetResponse")
	assert.Contains(t, result, "RemoteAccessPolicyAppliesToMPSGetResponse")
}
